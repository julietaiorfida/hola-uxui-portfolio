      ...
      <div className={`max-w-7xl mx-auto w-full ${isVisible ? 'scroll-fade-in' : 'opacity-0'}`}>
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center gap-6 pt-8">
            <Button variant="outline" size="icon" asChild className="rounded-full w-28 h-28 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all hover:scale-110">
