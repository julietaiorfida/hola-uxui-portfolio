    ...
    <section id="contact" className="min-h-screen py-20 px-6 flex items-center bg-gradient-to-b from-secondary/10 via-background to-accent/5 relative overflow-hidden">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div ref={buttonsRef} className="flex justify-center gap-6 pt-8 flex-wrap">
            ...
            <div data-reveal-item>
              <Button variant="outline" size="icon" asChild className="group rounded-full w-28 h-28 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all hover:scale-110">
                <a href="https://www.behance.net/mariajulietaiorfida" target="_blank" rel="noopener noreferrer">
                   <svg className="h-12 w-12 transition-transform duration-200 ease-out group-hover:scale-105" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div data-reveal-item>
              <Button variant="outline" size="icon" asChild className="group rounded-full w-28 h-28 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all hover:scale-110">
                <a href="https://wa.me/5491127950179" target="_blank" rel="noopener noreferrer">
                  <svg className="h-14 w-14 transition-transform duration-200 ease-out group-hover:scale-105" viewBox="0 0 24 24" fill="currentColor">
