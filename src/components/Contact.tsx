  ...
  return (
    <section id="contact" className="min-h-screen py-24 px-6 flex items-center bg-gradient-to-b from-[hsl(var(--section-rosa-light))] to-[hsl(var(--section-white))] border-t border-border/30 relative overflow-hidden">
      <div className="max-w-7xl mx-auto w-full">
        <div ref={titleRef}>
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-primary mb-16 text-center">
            {t("contact.title")}
          </h2>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div ref={buttonsRef} className="flex flex-wrap justify-center gap-3 sm:gap-6 pt-8">
            <div data-reveal-item>
              <Button variant="outline" size="icon" asChild className="group rounded-full w-16 h-16 sm:w-28 sm:h-28 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all hover:scale-110">
                <a href="https://www.linkedin.com/in/mariajulietaiorfida/" target="_blank" rel="noopener noreferrer">
                  <Linkedin className="h-10 w-10 sm:h-24 sm:w-24 transition-transform duration-200 ease-out group-hover:scale-105" />
                </a>
              </Button>
            </div>
            <div data-reveal-item>
              <Button variant="outline" size="icon" asChild className="group rounded-full w-16 h-16 sm:w-28 sm:h-28 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all hover:scale-110">
                <a href="https://www.behance.net/mariajulietaiorfida" target="_blank" rel="noopener noreferrer">
                   <svg className="h-10 w-10 sm:h-24 sm:w-24 transition-transform duration-200 ease-out group-hover:scale-105" viewBox="0 0 24 24" fill="currentColor">
