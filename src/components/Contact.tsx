...
const Contact = () => {
  ...
  return <section id="contact" className="min-h-screen py-20 px-6 flex items-center bg-background relative overflow-hidden" ref={ref}>
      {/* Decorative stickers */}
      ...
      <div className={`max-w-7xl mx-auto w-full ${isVisible ? 'scroll-fade-in' : 'opacity-0'}`}>
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center gap-6 pt-8">
            <Button variant="outline" size="icon" asChild className="rounded-full w-16 h-16 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all">
              <a href="https://www.linkedin.com/in/maría-julieta-iorfida-9a27672b8/" target="_blank" rel="noopener noreferrer">
                <Linkedin className="h-6 w-6" />
              </a>
            </Button>
            <Button variant="outline" size="icon" asChild className="rounded-full w-16 h-16 border-2 shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary hover:shadow-primary/50 transition-all">
              <a href="https://www.behance.net/chulyy" target="_blank" rel="noopener noreferrer">
