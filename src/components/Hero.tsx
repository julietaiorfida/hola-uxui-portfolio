    ...
    <section className="min-h-screen flex items-center relative overflow-hidden bg-white">
      ...
      <div className="w-full h-full flex items-center">
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          {/* Left Column - Text */}
          <div className="relative z-10 pl-6 md:pl-20 lg:pl-32 flex-1 flex items-center justify-center w-full pt-24 md:pt-0">
          ...
          {/* Right Column - Video */}
          <div ref={videoRef} className="relative h-[45vh] md:h-screen flex items-center justify-end w-full md:w-auto md:-mr-5">
            <video
              src={heroVideo}
              autoPlay
              loop
